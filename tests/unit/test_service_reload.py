...
class _FakeScreen:
    """Double minimal du seul membre de OmegaScreen utilise par
    reload_service_if_active - jamais un vrai App/terminal en test."""
...
class TestReloadServiceAfterWafChange(unittest.TestCase):
    ...
    def test_no_manager_factory_returns_none_silently(self):
        ...
        self.assertIsNone(reload_service_after_waf_change(self.screen, container))
    ...
    def test_active_service_is_reloaded_and_a_message_is_returned(self):
        ...
        container = self._container(manager)
        message = reload_service_after_waf_change(self.screen, container)
